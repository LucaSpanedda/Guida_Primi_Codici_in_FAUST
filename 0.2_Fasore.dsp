//Per ottenere un segnale FASORE, dal nostro segnale di Rampa ad incremento infinito,
...
//E mantenere dunque invece, i suoi decimali che hanno un determinato incremento 
//alla base
...
//il fasore muovendo ogni campione per un incremento di 0.002 arriva da 0.002 a 1 in 500 campioni
//500 incrementi susseguenti di 0.002. 
//avendo 48000 samples che definiscono un secondo, in 48000 samples 500 ci stanno 96 volte
//creando dunque 96Hz di frequenza (96 oscillazioni al secondo),

//process infine, è la funzione finale e dice che il nostro fasore che si muove ora tra 0. e 1. 
//con - 0.5, si muove tra - 0.5 e +0.5, e moltiplicando *2, si muove tra -1. e 1.
